...
<body>
  ...
  <script>
    ...
    const openAuxWindow = (id,title) => {
      ...
      win=document.createElement('section'); win.className='aux-window'; win.dataset.windowId=id; win.innerHTML=auxMarkup(id,title); document.body.appendChild(win);if(id==='listeler'||id==='staff'){win.style.width='900px';win.style.height='500px';}if(id==='stock'){win.style.width='1080px';win.style.height='590px';}if(id==='shifts'){win.style.width='1120px';win.style.height='590px';}if(id==='setup'){win.style.width='840px';win.style.height='520px';}if(id.startsWith('member-')){win.style.width='900px';win.style.height='530px';}if(id.startsWith('employee-')){win.style.width='960px';win.style.height='620px';}
