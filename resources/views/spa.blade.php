...
<body>
  ...
  <script>
    ...
    let reservationData={view:'month',anchorDate:localIso(new Date()),month:localIso(new Date()).slice(0,7),reservations:[],members:[],employees:[]};
    ...
    const reservationMarkup=title=>`<div class="aux-titlebar"><span>${title}</span><div class="window-controls"><button type="button" data-act="min">_</button><button type="button" data-act="max">□</button><button type="button" class="window-close" data-act="close">×</button></div></div><div class="reservation-shell"><nav class="reservation-tabs"><button type="button" class="active" data-reservation-tab="calendar"><span>▦</span>Takvim</button><button type="button" data-reservation-tab="form"><span>⊕</span>Yeni Rezervasyon</button><button type="button" data-reservation-tab="list"><span>▤</span>Rezervasyon Listesi</button></nav><div class="reservation-toolbar"><button type="button" data-reservation-command="new">⊕ Yeni</button><button type="button" data-reservation-command="save">💾 Kaydet</button><button type="button" data-reservation-command="refresh">🔄 Yenile</button><div class="reservation-view-switch" aria-label="Takvim görünümü"><button type="button" data-reservation-view="day">Günlük</button><button type="button" data-reservation-view="week">Haftalık</button><button type="button" class="active" data-reservation-view="month">Aylık</button></div><span class="reservation-message" role="status"></span></div><section class="reservation-panel" data-reservation-panel="calendar">Takvim yükleniyor…</section><section class="reservation-panel" data-reservation-panel="form" hidden>${reservationForm()}</section><section class="reservation-panel" data-reservation-panel="list" hidden>${reservationListMarkup()}</section></div>`;
